...
const FooterComponent = () => {
  ...
  src="/blue.svg" 
  alt="Icon" 
  className="h-6 w-6 text-blue-600 mr-1" 
/>
            ...
            <div className="flex space-x-2">
              <a href="https://www.facebook.com/share/15XZo7xYgp/?mibextid=LQQJ4d" className="bg-blue-800 text-white p-2 rounded hover:bg-gray-600 transition-colors duration-300">
                <svg className="h-4 w-4" viewBox="0 0 320 512" fill="currentColor">
                  <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z" />
                </svg>
              </a>
              <a href="https://x.com/stepup_?t=zVdqwMSNx-EZa0RBH-RepQ&s=09" className="bg-blue-400 text-white p-2 rounded hover:bg-gray-600 transition-colors duration-300">
              ...
              <a href="https://www.threads.net/@stepup__consultancy" className="bg-red-600 text-white p-2 rounded hover:bg-gray-600 transition-colors duration-300">
