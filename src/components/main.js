...
//                     ? (scrolled ? 'text-blue-600' : 'text-black font-semibold')
//                     : (scrolled ? 'text-black hover:text-blue-600' : 'text-black/60 hover:text-black/80')
//                 }`}
//               >
...
//                     scrolled ? 'bg-blue-100/80' : 'bg-gray-300/30'
//                   }`}></span>
//                 )}
//               </button>
//             ))}
...
//                 key={section}
//                 onClick={() => scrollToSection(section)}
//                 className={`w-full text-left px-5 py-4 text-purple-800 text-xl font-medium hover:bg-white/10 rounded-xl transition-all duration-300 transform ${
...
//                 { icon: 'M16.5 12.5H13.5V15.5C13.5 16.1 13 16.5 12.5 16.5H11.5C10.9 16.5 10.5 16.1 10.5 15.5V12.5H7.5C6.9 12.5 6.5 12 6.5 11.5V10.5C6.5 9.9 6.9 9.5 7.5 9.5H10.5V6.5C10.5 5.9 10.9 5.5 11.5 5.5H12.5C13 5.5 13.5 5.9 13.5 6.5V9.5H16.5C17.1 9.5 17.5 9.9 17.5 10.5V11.5C17.5 12 17.1 12.5 16.5 12.5Z' }
//               ].map((social, index) => (
//                 <a
//                   key={index}
//                   href="#"
...
//             {[
//               { name: 'Home', path: '/' },
//               { name: 'Instructors', path: '/inst' },
//               { name: 'About', path: '/about' },
//               { name: 'Abroad', path: '/abroad' }
//             ].map((item) => (
//               <button 
//                 key={item.name}
...
//                     : 'text-white hover:bg-white/20 hover:text-white/80'
//                 }`}
//               >
//                 <span className="relative z-10 capitalize">
//                   {item.name}
...
//                 scrolled 
//                   ? 'bg-gradient-to-r from-blue-600 to-blue-500 text-white shadow-md hover:shadow-lg' 
//                   : 'bg-white/20 text-white backdrop-blur-md shadow-md hover:shadow-xl'
//               }`}
//             >
//               Contact Us
//             </button>
            ...
            <Link href="/" className="flex items-center group">
              <div
                className={`relative transition-transform duration-500 transform group-hover:scale-110 ${
                  scrolled || !isHomepage 
                    ? "" 
                    : "hover:drop-shadow-[0_0_8px_rgba(0,0,0,0.5)]"
                }`}
              >
                <img 
                  src="/blue.svg" 
              ...
              <button 
                ...
                className={`px-4 py-2 mx-1 rounded-full font-medium transition-all duration-300 relative ${
                  scrolled 
                    ? 'text-blue-700 hover:bg-blue-100/50 hover:text-blue-800' 
                    : isHomepage
                      ? 'text-blue-900 hover:bg-blue-100/20 hover:text-blue-950'
                      : 'text-white hover:bg-white/20 hover:text-white/80'
                }`}
              >
                <span className="relative z-10 capitalize">
            ...
            <button
              ...
              className={`inline-flex items-center justify-center p-2 rounded-full ${
                scrolled 
                  ? 'text-gray-700 hover:bg-gray-100' 
                  : isHomepage
                    ? 'text-blue-900 hover:bg-blue-100/20'
                    : 'text-white hover:bg-white/20'
              } transition-all duration-300`}
              onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
            >
